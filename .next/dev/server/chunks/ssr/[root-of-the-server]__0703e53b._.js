...
;
const metadata = {
    title: "Capture Moments | Pakistani Wedding Photography & Videography",
    description: "Premium wedding photography and videography services in Pakistan. Capturing your special moments with cinematic excellence.",
    generator: "v0.app",
    icons: {
        icon: [
            {
