        ...
        "AdminDashboard.useEffect": ()=>{
            const fetchPosts = {
                "AdminDashboard.useEffect.fetchPosts": async ()=>{
                    setLoading(true);
                    try {
                        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blog$2d$data$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPosts"])();
                        // console.log(data);
                        setBlogPosts(data);
