...
function AdminDashboard() {
    _s();
    const [blogPosts, setBlogPosts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "AdminDashboard.useEffect": ()=>{
            const fetchPosts = {
                "AdminDashboard.useEffect.fetchPosts": async ()=>{
                    setLoading(true);
                    try {
                        const { data, posts } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blog$2d$data$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPosts"])();
                        // console.log(data);
                        setBlogPosts(posts);
...
_s(AdminDashboard, "WlFjPhRHviK1FIN/pLbUsJOMMHQ=");
_c = AdminDashboard;
var _c;
